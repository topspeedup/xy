<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:30:"Tpl/Home/vendoruser\index.html";i:1516712549;s:52:"D:\wwwroot\zs_tlm45a\web\Tpl\Home\Common\header.html";i:1516822789;s:53:"D:\wwwroot\zs_tlm45a\web\Tpl\Home\Common\sidebar.html";i:1516883927;s:52:"D:\wwwroot\zs_tlm45a\web\Tpl\Home\Common\footer.html";i:1516887689;}*/ ?>
<!--
/**
...
<div class="mdui-container-fluid wz-top-20 wz-left-10">
  <div class="wz-main">
    <div class="mdui-card wz-bottom-20">
    	...
    	<button class="layui-btn layui-btn-normal"  mdui-dialog="{target: '#info'}"><i class="layui-icon">&#xe61f;</i>  添加店铺信息</button>
	<table class="layui-table">
	  ...
	  <tbody>
	  <?php if(is_array($ShopInfoList) || $ShopInfoList instanceof \think\Collection || $ShopInfoList instanceof \think\Paginator): $i = 0; $__LIST__ = $ShopInfoList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
	    <tr>
	      <td><?php echo $vo['id']; ?></td>
	      <td><?php echo $vo['shopname']; ?></td>
	      <td><?php echo $vo['shopclass']; ?></td>
	      <td><?php echo $vo['shopqq']; ?></td>
	      <td><?php echo $vo['weixin']; ?></td>
	      <td><?php echo $vo['autqq']; ?></td>
	      <td class="dj"><?php if($vo['grade']): ?><?php echo $vo['grade']; else: ?>一般<?php endif; ?></td>
	      <td class="info"><?php echo $vo['beizhu']; ?></td>
	      <td><a href="<?php echo url('del',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-sm layui-btn-radius layui-btn-danger">删除</a></td>
	    </tr>
  ...
  <div class="mdui-dialog" id="info">
    <div class="mdui-dialog-content">
      <div class="mdui-dialog-title">添加店铺信息</div>
      <form class="layui-form" action="" style="margin-left: -35px;">
	  <div class="layui-form-item">
	    <label class="layui-form-label">商品链接</label>
	    <div class="layui-input-block">
	      <input type="text" name="shopurl" required  lay-verify="required" placeholder="请输入商品链接" autocomplete="off" class="layui-input">
	    </div>
	  </div>
	  <div class="layui-form-item">
	  ...
	  <div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
	      <select name="shopclass" lay-verify="required">
	  ...
	  <div class="layui-form-item">
	    <label class="layui-form-label">店铺QQ</label>
	    <div class="layui-input-block">
	      <input type="text" name="shopqq" required  lay-verify="required" placeholder="请输入店铺QQ" autocomplete="off" class="layui-input">
	    </div>
	  </div>
	  <div class="layui-form-item">
	    <label class="layui-form-label">联系QQ</label>
	    <div class="layui-input-block">
	      <input type="text" name="autqq" required  lay-verify="required" placeholder="请输入联系QQ" autocomplete="off" class="layui-input">
	    </div>
	  </div>
	  <div class="layui-form-item">
	    <label class="layui-form-label">电话/微信</label>
	    <div class="layui-input-block">
	      <input type="text" name="weixin" required  lay-verify="required" placeholder="请输入电话或者微信" autocomplete="off" class="layui-input">
	    </div>
	  </div>
	  <div class="layui-form-item">
	    <div class="layui-input-block">
	      <button class="layui-btn" lay-submit lay-filter="submit" data-url="<?php echo url('submitven'); ?>">立即添加</button>
	    </div>
	  </div>
      </form>
    </div>
