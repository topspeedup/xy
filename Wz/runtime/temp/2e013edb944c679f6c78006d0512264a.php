<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:27:"Tpl/Home/recycle\index.html";i:1516820987;s:52:"D:\wwwroot\zs_tlm45a\web\Tpl\Home\Common\header.html";i:1516822789;s:53:"D:\wwwroot\zs_tlm45a\web\Tpl\Home\Common\sidebar.html";i:1516883927;s:52:"D:\wwwroot\zs_tlm45a\web\Tpl\Home\Common\footer.html";i:1516887689;}*/ ?>
<!--
/**
...
<div class="mdui-container-fluid wz-top-20 wz-left-10">
  <div class="wz-main">
	...
	<table class="layui-table">
	  ...
	  <tbody>
	  <?php if(is_array($ShopDelList) || $ShopDelList instanceof \think\Collection || $ShopDelList instanceof \think\Paginator): $i = 0; $__LIST__ = $ShopDelList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
	    <tr>
	      ...
	      <td><?php if($vo['delstatu'] == 1): ?><span class="layui-badge " style="background-color: #18bc9c!important;">已删除</span><?php endif; ?></td>
	      <td><div class="layui-btn-group">
	      	<a href="<?php echo url('recovery',['id'=>$vo['id']]); ?>"  class="layui-btn layui-btn-sm layui-btn-normal">恢复宝贝</a><br><br>
	      	<a href="<?php echo url('del',['id'=>$vo['id']]); ?>"  class="layui-btn layui-btn-sm layui-btn-danger">彻底删除</a>
		</div>
	    </td>
	    </tr>
