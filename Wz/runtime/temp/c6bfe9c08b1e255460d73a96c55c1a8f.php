<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:38:"Tpl/Home/registration\receivables.html";i:1516707800;s:52:"D:\wwwroot\zs_tlm45a\web\Tpl\Home\Common\header.html";i:1516822789;s:53:"D:\wwwroot\zs_tlm45a\web\Tpl\Home\Common\sidebar.html";i:1516883927;s:52:"D:\wwwroot\zs_tlm45a\web\Tpl\Home\Common\footer.html";i:1516887689;}*/ ?>
<!--
/**
...
<div class="mdui-container-fluid wz-top-20 wz-left-10">
  <div class="wz-main">
	...
	<table class="layui-table">
	  ...
	  <tbody>
	    <tr>
	      <td><?php echo $ReceivablesDataInfo['id']; ?></td>
	      <td><img src="<?php echo $ReceivablesDataInfo['shopimg']; ?>" width="100" height="100"></td>
	      <td><a href="<?php echo $ReceivablesDataInfo['url']; ?>" target="_blank"><?php echo $ReceivablesDataInfo['shoptitle']; ?></a></td>
	      <td><?php echo getQuerystr($ReceivablesDataInfo['url'],'id'); ?></td>
	      <td><?php echo getQuerystr($ReceivablesDataInfo['youhui'],'activityId'); ?></td>
	      <td><?php if($ReceivablesDataInfo['zzjt']): ?><img src="<?php echo $ReceivablesDataInfo['zzjt']; ?>"><?php endif; ?></td>
	      <td class="mjzf"><?php echo $ReceivablesDataInfo['mjzf']; ?></td>
	      <td><?php echo $ReceivablesDataInfo['houjia']; ?></td>
	      <td><?php echo $ReceivablesDataInfo['fwf']; ?></td>
	      <td><?php  $Calculation = $ReceivablesDataInfo['zfje'] / $ReceivablesDataInfo['houjia'] * $ReceivablesDataInfo['fwf']; echo sprintf("%.1f",$Calculation);  ?></td>
	    </tr>
	  </tbody>
	</table>
	<form class="layui-form" action="" style="margin-top: 50px;">
	    ...
	    <a class="layui-btn layui-btn-normal" id="cimg" style="float: left;" width="100"><i class="layui-icon">&#xe67c;</i>上传转账截图</a>
	    <div class="layui-input-block" style="margin-left: 268px;">
	  <input type="text" name="zzjt" value="<?php echo $ReceivablesDataInfo['zzjt']; ?>" id="thu" placeholder="请上传转账截图" class="layui-input" style="position: absolute;left: -17px;top: 0;width: 50%;">
	  </div>
	  </div>
	  <div class="layui-form-item">
	    <label class="layui-form-label"></label>
	    <div class="layui-input-block">
	     <img src="<?php echo $ReceivablesDataInfo['zzjt']; ?>">
	    </div>
	  </div>
	  <div class="layui-form-item">
	    <label class="layui-form-label">实收金额</label>
	    <div class="layui-input-block">
	      <input type="text" name="ssje" required  lay-verify="required" placeholder="请输入商家实收金额" autocomplete="off" class="layui-input" style="width: 20%;" value="<?php echo $ReceivablesDataInfo['ssje']; ?>">
	    </div>
	  </div>
	  <div class="layui-form-item">
	    <label class="layui-form-label">备注</label>
	    <div class="layui-input-block">
	      <input type="text" name="skbz" required  lay-verify="required" placeholder="请输入收款备注" autocomplete="off" class="layui-input" style="width: 20%;" value="<?php echo $ReceivablesDataInfo['skbz']; ?>">
	    </div>
	  </div>
	  <div class="layui-form-item">
	    <div class="layui-input-block">
	    <input type="hidden" name="id" value="<?php echo $ReceivablesDataInfo['id']; ?>">
	      <button class="layui-btn layui-btn-normal layui-btn-lg" lay-submit lay-filter="submit" data-url="<?php echo url('collectionpreservation'); ?>">保存</button>
	    </div>
	  </div>
	</form>
	</div>
