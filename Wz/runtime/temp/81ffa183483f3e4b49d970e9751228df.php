<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:24:"Tpl/Home/user\index.html";i:1516893895;s:52:"D:\wwwroot\zs_tlm45a\web\Tpl\Home\Common\header.html";i:1516822789;s:53:"D:\wwwroot\zs_tlm45a\web\Tpl\Home\Common\sidebar.html";i:1516883927;s:52:"D:\wwwroot\zs_tlm45a\web\Tpl\Home\Common\footer.html";i:1516887689;}*/ ?>
<!--
/**
	...
	<table class="layui-table">
	  ...
	  <?php if(is_array($AdminList) || $AdminList instanceof \think\Collection || $AdminList instanceof \think\Paginator): $i = 0; $__LIST__ = $AdminList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
	    <tr>
	      ...
	      <td><?php if($vo['statu'] == 1): ?>招商人员<?php endif; if($vo['statu'] == 2): ?>上单人员<?php endif; if($vo['statu'] == 3): ?>财务人员<?php endif; if($vo['statu'] == 4): ?>管理人员<?php endif; ?></td>
	      <td>
		<div class="layui-btn-group">
		<?php if($vo['statu'] == 1): ?>
		<a href="<?php echo url('qx',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-danger layui-btn-sm">取消招商</a>
		<?php else: ?>
		<a href="<?php echo url('zs',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-normal layui-btn-sm">招商人员</a>
		<?php endif; if($vo['statu'] == 2): ?>
		<a href="<?php echo url('qx',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-danger layui-btn-sm">取消上单</a>
		<?php else: ?>
		<a href="<?php echo url('sd',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-normal layui-btn-sm">上单人员</a>
		<?php endif; if($vo['statu'] == 3): ?>
		<a href="<?php echo url('qx',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-danger layui-btn-sm">取消财务</a>
		<?php else: ?>
		<a href="<?php echo url('cw',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-normal layui-btn-sm">财务人员</a>
		<?php endif; if($vo['statu'] == 4): ?>
		<a href="<?php echo url('qxgl',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-danger layui-btn-sm">取消管理</a>
		<?php else: ?>
		<a href="<?php echo url('gl',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-normal layui-btn-sm">管理人员</a>
		<?php endif; ?>
		</div>
	      </td>
	      ...
	      <td>
		  <?php if($vo['jy'] == 0): ?>
		  <a href="<?php echo url('jy',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-normal layui-btn-sm">禁用用户</a>
		  <?php else: ?>
		  <a href="<?php echo url('qxjy',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-danger layui-btn-sm">取消禁用</a>
		  <?php endif; ?>
		  <a href="<?php echo url('del',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-danger layui-btn-sm">删除</a>
		  </td>
	    </tr>
