<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:30:"Tpl/Home/singleshop\renew.html";i:1516718722;s:52:"D:\wwwroot\zs_tlm45a\web\Tpl\Home\Common\header.html";i:1516822789;s:53:"D:\wwwroot\zs_tlm45a\web\Tpl\Home\Common\sidebar.html";i:1516883927;s:52:"D:\wwwroot\zs_tlm45a\web\Tpl\Home\Common\footer.html";i:1516887689;}*/ ?>
<!--
/**
    ...
    <div class="mdui-card wz-bottom-20">
		...
		<div class="layui-form-item">
		    ...
		    <div class="layui-input-block">
		      <input  name="url" id="input" class="layui-input" style="width: 90%;" value="<?php echo $RenewInfo['url']; ?>" disabled><br>
		...
		<div class="layui-form-item">
		    ...
		    <div class="layui-input-block">
		      <input  type="text" class="layui-input" name="fwf" style="width: 90%;" <?php if($RenewInfo['url']): ?>value="<?php echo $RenewInfo['url']; ?>"{esle/}placeholder="请输入服务费 如：10"<?php endif; ?>>
		    </div>
		  </div>
		<div class="layui-form-item layui-form">
		    ...
		    <div class="layui-input-block" id="selTitleDiv" style="width: 59%;">
		      ...
		      <?php if(is_array($ShopClassList) || $ShopClassList instanceof \think\Collection || $ShopClassList instanceof \think\Paginator): $i = 0; $__LIST__ = $ShopClassList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$clas): $mod = ($i % 2 );++$i;?>
		        <option value="<?php echo $clas['name']; ?>" <?php if($clas['name'] == $RenewInfo['class']): ?> selected = "selected" <?php endif; ?>><?php echo $clas['name']; ?></option>
		...
		<div class="layui-form-item">
		    ...
		    <div class="layui-input-block">
		      <input  type="text" class="layui-input" name="shopname" id="shopname" style="width: 90%;" value="<?php echo $RenewInfo['shopname']; ?>">
		    </div>
		  </div>
		<div class="layui-form-item">
		    <label class="layui-form-label">商品标题</label>
		    <div class="layui-input-block">
		      <input  type="text" id="title" name="shoptitle" class="layui-input" style="width: 90%;" disabled value="<?php echo $RenewInfo['shoptitle']; ?>">
		    </div>
		  </div>
		<div class="layui-form-item">
		    <label class="layui-form-label">商品短标题</label>
		    <div class="layui-input-block">
		      <input  type="text" name="shopmaxtitle" datatype='/.{5,16}/' minlength="5" maxlength="16" class="layui-input" style="width: 90%;"  <?php if($RenewInfo['shopmaxtitle']): ?>value="<?php echo $RenewInfo['shopmaxtitle']; ?>"{esle/}placeholder="5-16字，输入精简优质的短标题"<?php endif; ?>>
		    </div>
		  </div>
		  <div class="layui-form-item layui-form-text">
		    <label class="layui-form-label">推荐文案</label>
		    <div class="layui-input-block">
		      <textarea name="wenan" placeholder="20-150字文案，突出亮点，为什么值得买。不能有空格" minlength="20" maxlength="150" id="wenan" class="layui-textarea" style="width: 90%;"><?php echo $RenewInfo['wenan']; ?></textarea>
		    </div>
		  </div>
		<div class="layui-form-item">
		    <label class="layui-form-label">商品主图</label>
		    <div class="layui-input-block">
		      <input  type="text" name="shopimg"  id="img" class="layui-input" style="width: 90%;" value="<?php echo $RenewInfo['shopimg']; ?>">
		    </div>
		  </div>
		  <?php if($RenewInfo['shopimg']): ?>
		<div class="layui-form-item">
		    <div class="layui-input-block">
		     <img src="<?php echo $RenewInfo['shopimg']; ?>" width="100" height="100">
		    </div>
		  </div>
		  <?php else: ?>
		<div class="layui-form-item">
		  ...
		  <input type="text" name="changtu" value="" id="thu" class="layui-input" style="position: absolute;left: -17px;top: 0;"  <?php if($RenewInfo['changtu']): ?>value="<?php echo $RenewInfo['changtu']; ?>"{esle/}placeholder="请上传商品长图"<?php endif; ?>>
		  </div>
		  </div>
		  <?php if($RenewInfo['changtu']): ?>
		<div class="layui-form-item">
		    <div class="layui-input-block">
		     <img src="<?php echo $RenewInfo['changtu']; ?>" width="100" height="100">
		    </div>
		  </div>
		  <?php else: ?>
		<div class="layui-form-item">
		...
		<div class="layui-form-item">
		    ...
		    <div class="layui-input-block">
		      <input  type="text" class="layui-input" name="beizhu" style="width: 90%;" <?php if($RenewInfo['beizhu']): ?>value="<?php echo $RenewInfo['beizhu']; ?>"{esle/}placeholder="请输入商品备注"<?php endif; ?>>
		    </div>
		  </div>
		  </div>
		  <div class="layui-form-item">
		    ...
		    <div class="layui-input-block">
		      <input type="text"  name="youhui" id="youhui" class="layui-input" style="width: 90%;" value=""><br>
		       <a id="xud" class="layui-btn layui-btn-normal">查询优惠券</a>
		    </div>
		  </div>
		  <div class="layui-form-item">
		  ...
		  <div class="layui-form-item">
		    <div class="layui-input-block">
		      <input type="hidden" name="id" value="<?php echo $RenewInfo['id']; ?>">
		      <input type="hidden" name='jjine' value="">
		      <input type="hidden" name='xiaoliang' value="">
		      <button class="layui-btn" lay-submit lay-filter="submit" data-url="<?php echo url('index/singleshop/renewsend'); ?>">立即续单</button>
		    </div>
		  </div>
	     </form>
	</div>
