<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:30:"Tpl/Home/statistics\index.html";i:1516822676;s:52:"D:\wwwroot\zs_tlm45a\web\Tpl\Home\Common\header.html";i:1516822789;s:53:"D:\wwwroot\zs_tlm45a\web\Tpl\Home\Common\sidebar.html";i:1516883927;s:52:"D:\wwwroot\zs_tlm45a\web\Tpl\Home\Common\footer.html";i:1516887689;}*/ ?>
<!--
/**
  ...
  <div class="wz-main">
	...
	<div class="layui-form-item">
	  <div class="layui-inline">
	    <label class="layui-form-label" style="width: 90px;">时间搜索</label>
	    <div class="layui-input-inline" style="width: 200px;">
	      <input type="text" name="kstime" id="time5" placeholder="请选择时间" autocomplete="off" class="layui-input">
	    </div>
	    <div class="layui-form-mid">-</div>
	    <div class="layui-input-inline" style="width: 200px;">
	      <input type="text" name="jstime" id="time6" placeholder="请选择时间" autocomplete="off" class="layui-input">
	    </div>
	    <div class="layui-form-mid" style="padding: 0px 0!important;margin-left: -10px;"><button class="layui-btn layui-btn-normal">搜索</button></div>
	    <div class="layui-form-mid" style="padding: 0px 0!important;margin-left: 0;"><input type="text" name="zsxm" placeholder="请输入真实姓名" autocomplete="off" class="layui-input"></div>
	    <div class="layui-input-inline" style="width: 100px;">
	      <button class="layui-btn layui-btn-normal" style="margin-left: -10px;">搜索真实姓名</button>
	    </div>
	  </div>
	  </div>
	</form>
	<table class="layui-table">
	  ...
	  <tbody>
	  <?php if(is_array($ShopShopStatisticsList) || $ShopShopStatisticsList instanceof \think\Collection || $ShopShopStatisticsList instanceof \think\Paginator): $i = 0; $__LIST__ = $ShopShopStatisticsList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
	    <tr>
	      <td><?php echo $vo['name']; ?></td>
	      <td><a href="<?php echo $vo['url']; ?>" target="_black"><?php echo $vo['shoptitle']; ?></a></td>
	      <td><?php echo $vo['time']; ?></td>
	      <td><?php echo $vo['ssje']; ?></td>
	    </tr>
