<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:29:"Tpl/Home/shopclass\index.html";i:1516709379;s:52:"D:\wwwroot\zs_tlm45a\web\Tpl\Home\Common\header.html";i:1516822789;s:53:"D:\wwwroot\zs_tlm45a\web\Tpl\Home\Common\sidebar.html";i:1516883927;s:52:"D:\wwwroot\zs_tlm45a\web\Tpl\Home\Common\footer.html";i:1516887689;}*/ ?>
<!--
/**
...
<div class="mdui-container-fluid wz-top-20 wz-left-10">
  <div class="wz-main">
    <div class="mdui-card wz-bottom-20">
    	...
    	<button class="layui-btn layui-btn-normal"  mdui-dialog="{target: '#class'}"><i class="layui-icon">&#xe61f;</i> 添加商品类目</button>
	<table class="layui-table">
	  ...
	  <tbody>
	  <?php if(is_array($ShopClassList) || $ShopClassList instanceof \think\Collection || $ShopClassList instanceof \think\Paginator): $i = 0; $__LIST__ = $ShopClassList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
	    <tr>
  ...
  <div class="mdui-dialog" id="class">
    <div class="mdui-dialog-title">添加商品类目</div>
    <div class="mdui-dialog-content">
<form class="layui-form" action="" style="margin-left: -35px;" method="post">
  <div class="layui-form-item">
    <label class="layui-form-label">类目名称</label>
    <div class="layui-input-block">
      <input type="text" name="class" required  lay-verify="required" placeholder="请输入类目名称" autocomplete="off" class="layui-input">
    </div>
  </div>
    <div class="layui-form-item">
    <div class="layui-input-block">
      <button class="layui-btn" lay-submit lay-filter="submit" data-url="<?php echo url('addclass'); ?>">立即添加</button>
    </div>
  </div>
</form>
    </div>
