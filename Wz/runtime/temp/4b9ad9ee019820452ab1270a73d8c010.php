<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:29:"Tpl/Home/financial\index.html";i:1516784118;s:52:"D:\wwwroot\zs_tlm45a\web\Tpl\Home\Common\header.html";i:1516822789;s:53:"D:\wwwroot\zs_tlm45a\web\Tpl\Home\Common\sidebar.html";i:1516883927;s:52:"D:\wwwroot\zs_tlm45a\web\Tpl\Home\Common\footer.html";i:1516887689;}*/ ?>
<!--
/**
...
<div class="mdui-container-fluid wz-top-20 wz-left-10">
  <div class="wz-main">
	...
	<table class="layui-table">
	  ...
	  <tbody>
	  <?php if(is_array($ShopFinancialList) || $ShopFinancialList instanceof \think\Collection || $ShopFinancialList instanceof \think\Paginator): $i = 0; $__LIST__ = $ShopFinancialList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
	    <tr>
	      <td><?php echo $vo['id']; ?></td>
	      <td><img src="<?php echo $vo['shopimg']; ?>" width="100" height="100"></td>
	      <td><a href="<?php echo $vo['url']; ?>" target="_blank"><?php echo $vo['shoptitle']; ?></a></td>
	      <td>ID：<a href="<?php echo $vo['url']; ?>" style="color: red;" target="_blank"><?php echo getQuerystr($vo['url'],'id'); ?></a></td>
	      <td style="word-break:break-all;"><a href="<?php echo $vo['youhui']; ?>" style="color: red;" target="_blank"><?php echo getQuerystr($vo['youhui'],'activityId'); ?></a></td>
	      <td><?php if($vo['zzjt']): ?><img src="<?php echo $vo['zzjt']; ?>"><?php endif; ?></td>
	      	      <td>支付金额：<span style="font-weight: bold;">￥<?php echo $vo['zfje']; ?></span><br>
	      	 结算券后价：<span style="font-weight: bold;">￥<?php echo $vo['houjia']; ?></span><br>
	      	 服务费单价：<span style="font-weight: bold;">￥<?php echo $vo['fwf']; ?></span><br>
	      	 结算金额：<span style="font-weight: bold;word-break:break-all;">￥<?php  $Calculation = $vo['zfje'] / $vo['houjia'] * $vo['fwf']; echo sprintf("%.1f",$Calculation);  ?></span><br>
	     </td>
	      <td><?php echo $vo['skbz']; ?></td>
	      <td><?php if($vo['hdstastu'] == 3): ?><span style="color: #0db500">已核对</span><?php endif; if($vo['hdstastu'] == 2): ?><span style="color: red">需审核</span><?php endif; if($vo['hdstastu'] == 1): ?><span>未核对</span><?php endif; ?></td>
	    </tr>
