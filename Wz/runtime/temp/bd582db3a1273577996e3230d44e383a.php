<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:26:"Tpl/Home/config\index.html";i:1516887595;s:52:"D:\wwwroot\zs_tlm45a\web\Tpl\Home\Common\header.html";i:1516822789;s:53:"D:\wwwroot\zs_tlm45a\web\Tpl\Home\Common\sidebar.html";i:1516883927;s:52:"D:\wwwroot\zs_tlm45a\web\Tpl\Home\Common\footer.html";i:1516887689;}*/ ?>
<!--
/**
  ...
  <div class="wz-main">
	...
	<form class="layui-form" action="" method="post">
	  <div class="layui-form-item">
	    <label class="layui-form-label" style="width: 90px;">管理密码修改</label>
	    <div class="layui-input-block" style="margin-left: 120px;">
	      <input type="text" name="pwd" placeholder="请输入新密码" autocomplete="off" class="layui-input">
	    </div>
	  </div>
	  <div class="layui-form-item">
	    ...
	    <?php if($regdata['in'] == 1): ?>
	    <button  class="layui-btn layui-btn-sm layui-btn-radius layui-btn-normal reg" data-id="1" data-url="<?php echo url('reg'); ?>">已开启注册</button>
	    <?php else: ?>
	   <button  class="layui-btn layui-btn-sm layui-btn-radius layui-btn-danger reg" data-id="1" data-url="<?php echo url('reg'); ?>">已关闭注册</button>
	    <?php endif; ?>
	    </div>
	  </div>
	  <div class="layui-form-item">
	    <div class="layui-input-block">
	    <input type="hidden" name="id" value="<?php echo session('admin.id'); ?>">
