<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:30:"Tpl/Home/singleshop\index.html";i:1516820771;s:52:"D:\wwwroot\zs_tlm45a\web\Tpl\Home\Common\header.html";i:1516822789;s:53:"D:\wwwroot\zs_tlm45a\web\Tpl\Home\Common\sidebar.html";i:1516883927;s:52:"D:\wwwroot\zs_tlm45a\web\Tpl\Home\Common\footer.html";i:1516887689;}*/ ?>
<!--
/**
  ...
  <div class="wz-main">
	...
	<div class="layui-form-item">
	  <div class="layui-inline">
	    <div class="layui-form-mid" style="padding: 0px 0!important;margin-left: 0;"><input type="text" name="cz" placeholder="请输入用户名" autocomplete="off" class="layui-input"></div>
	    <div class="layui-input-inline" style="width: 100px;">
	      <button class="layui-btn layui-btn-normal" style="margin-left: -10px;">搜索操作人</button>
	    </div>
	...
	<table class="layui-table">
	  ...
	  <?php if(is_array($ShopUserList) || $ShopUserList instanceof \think\Collection || $ShopUserList instanceof \think\Paginator): $i = 0; $__LIST__ = $ShopUserList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
	    <tr>
	      ...
	      <td>
		<?php if($vo['da']): ?><span class="layui-badge " style="background-color: #18bc9c!important;">大发布：<?php echo $vo['da']; ?></span><?php endif; if($vo['hao']): ?><span class="layui-badge" style="background-color: #18bc9c!important;">好发布：<?php echo $vo['hao']; ?></span><?php endif; if($vo['zhu']): ?><span class="layui-badge" style="background-color: #18bc9c!important;">猪发布：<?php echo $vo['zhu']; ?></span><?php endif; if($vo['qt']): ?><span class="layui-badge" style="background-color: #18bc9c!important;">其他发布：<?php echo $vo['qt']; ?></span><?php endif; ?>
	      </td>
	      <td>
	      	<div class="layui-btn-group">
	      	<a href="<?php echo url('edit',['id'=>$vo['id']]); ?>"  class="layui-btn">编辑</a><br><br>
