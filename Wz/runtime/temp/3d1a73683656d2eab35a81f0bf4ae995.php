<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:32:"Tpl/Home/registration\index.html";i:1516820601;s:52:"D:\wwwroot\zs_tlm45a\web\Tpl\Home\Common\header.html";i:1516822789;s:53:"D:\wwwroot\zs_tlm45a\web\Tpl\Home\Common\sidebar.html";i:1516883927;s:52:"D:\wwwroot\zs_tlm45a\web\Tpl\Home\Common\footer.html";i:1516887689;}*/ ?>
<!--
/**
	...
	<table class="layui-table">
	  ...
	  <?php if(is_array($ShopUserList) || $ShopUserList instanceof \think\Collection || $ShopUserList instanceof \think\Paginator): $i = 0; $__LIST__ = $ShopUserList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
	    <tr>
	      ...
	      <td style="word-break:break-all;"><span class="layui-badge" style="background-color: #18bc9c!important;font-size: 15px;">券￥<?php echo $vo['jjine']; ?>元</span><br>
	      	<span style="color: red;">券ID：</span><a href="<?php echo $vo['youhui']; ?>" target="_blank" style="color: red;"><?php echo getQuerystr($vo['youhui'],'activityId'); ?></a><br>
	      	<span style="font-weight: bold;">券后价:￥<?php echo $vo['houjia']; ?></span><br>
	      	<span style="font-weight: bold;">券有效期</span><br>
	      	<span><?php echo date("Y-m-d",strtotime($vo['kstime'])); ?></span><br>
	      	<span><?php echo date("Y-m-d",strtotime($vo['jstime'])); ?></span>
	      ...
	      <td class="skbz"><?php echo $vo['skbeizhu']; ?></td>
	      <td>
	      	<div class="layui-btn-group">
	      	<a href="<?php echo url('receivables',['id'=>$vo['id']]); ?>"  class="layui-btn">收款</a><br><br>
	      	<a href="<?php echo url('renew',['id'=>$vo['id']]); ?>"  class="layui-btn layui-btn-normal">续单</a>
		</div>
	    </td>
	    </tr>
